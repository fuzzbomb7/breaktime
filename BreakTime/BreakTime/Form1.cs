...
namespace BreakTime
{
    public partial class Form1 : Form
    {
        ...
        private bool freshAPI(ref string xml)
        {
            ...
            auth.Encoding = System.Text.Encoding.UTF8;
        ...
        private void retrieveAllProjects()
        {
            ...
            // Request XML
            MemoryStream requestXml = new MemoryStream();
            ...
            string sendXml = Encoding.UTF8.GetString(requestXml.ToArray());
            ...
            for (int p = 1; p <= pages; p++)
            {
                ...
                if (pages > 1 && p < pages)
                {
                    ...
                    sendXml = Encoding.UTF8.GetString(requestXml.ToArray());
            ...
            {
                MemoryStream clientXml = new MemoryStream();
                ...
                string sendClientXml = Encoding.UTF8.GetString(clientXml.ToArray());
                ...
                try
                {
                    clientReadXml.ReadToFollowing("organization");
